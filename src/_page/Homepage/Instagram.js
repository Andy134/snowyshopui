                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-2 col-md-4 col-sm-4 p-0">
                            <div className="instagram__item set-bg" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/img/instagram/insta-1.jpg)` }}>
                        ...
                        <div className="col-lg-2 col-md-4 col-sm-4 p-0">
                            <div className="instagram__item set-bg" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/img/instagram/insta-2.jpg)` }}>
                                <div className="instagram__text">
                                    <i className="fa fa-instagram"></i>
                                    <a href="/">@ ashion_shop</a>
                                </div>
